...
class MyAppsNotificationManager {
    ...
    public Notification getNotif(Class targetNotificationActivity, String title,  int priority, boolean autoCancel, int notificationId){
